...
//   if (poses.length >= 1) {
//     const poseArray =
//       poses[0].pose !== undefined
//         ? poses[0].pose.keypoints.map(p => [
//             p.score,
//             p.position.x,
//             p.position.y
//           ])
...
//         result.label === "A" && confidences[result.label] * 100 >= 98
//           ? (countFlag.abool = true)
//           : null;
//         result.label === "B" && confidences[result.label] * 100 >= 98
//           ? (countFlag.bbool = true)
//           : null;
...
//           "Confidence: " + `${confidences[result.label] * 100} %`
//         );
//       }
//     }
        ...
        <div class="container-fluid text-center">
          <div class="row content">
            <div class="col-sm-2 sidenav">
              <h3>
                {" "}
                <span id="done" class="label label-warning">
                  Exercise Done: <span class="badge" id="exerciseDone"></span>
                </span>{" "}
              </h3>
            </div>
            <div
